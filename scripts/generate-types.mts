...
async function main() {
	...
	if (fs.existsSync(path.join("..", "Autogenlabs-Code-Types"))) {
		fs.copyFileSync("out/interface.js", path.join("..", "Autogenlabs-Code-Types", "src", "index.js"))
		fs.copyFileSync("out/interface.d.ts", path.join("..", "Autogenlabs-Code-Types", "src", "index.d.ts"))
	}
}
