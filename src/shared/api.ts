...
// AutogenLabs (A4F.co)
// https://a4f.co/models - 120+ AI models through A4F API
export type AutogenLabsModelId = keyof typeof autogenLabsModels
export const autogenLabsDefaultModelId: AutogenLabsModelId = "gpt-4o"
export const autogenLabsModels = {
	// OpenAI Models
	"gpt-4o": {
		maxTokens: 16384,
		contextWindow: 128000,
		...
		inputPrice: 2.5,
		outputPrice: 10.0,
		description: "Most advanced OpenAI model, great for complex reasoning and multimodal tasks.",
	},
	"gpt-4o-mini": {
		maxTokens: 16384,
		contextWindow: 128000,
		...
		inputPrice: 0.15,
		outputPrice: 0.6,
		description: "Faster, cheaper version of GPT-4o, excellent for most tasks.",
	},
	"gpt-4-turbo": {
		maxTokens: 4096,
		contextWindow: 128000,
	...
	"claude-3-5-sonnet-20241022": {
		...
		cacheWritesPrice: 3.75,
		cacheReadsPrice: 0.3,
		description: "Claude 3.5 Sonnet with advanced reasoning and tool use capabilities.",
	},
	"claude-3-5-haiku-20241022": {
		maxTokens: 8192,
		contextWindow: 200000,
		...
		cacheWritesPrice: 1.0,
		cacheReadsPrice: 0.08,
		description: "Fast and efficient Claude model with multimodal capabilities.",
	},
	"claude-3-opus-20240229": {
		maxTokens: 4096,
		contextWindow: 200000,
	...
	"gemini-1.5-flash": {
		...
		inputPrice: 0.075,
		outputPrice: 0.3,
		description: "Fast and efficient Google model with large context.",
	},
	// Meta Models
	...
	"llama-3.1-70b-instruct": {
		...
		inputPrice: 0.88,
		outputPrice: 2.64,
		description: "Powerful Llama model for complex reasoning tasks.",
	},
	...
	"mistral-medium": {
		...
		inputPrice: 2.7,
		outputPrice: 8.1,
		description: "Balanced performance and efficiency from Mistral.",
	},
	// Cohere Models
	"command-r-plus": {
		maxTokens: 4096,
	...
	"command-r": {
		...
		inputPrice: 0.5,
		outputPrice: 1.5,
		description: "Efficient Cohere model for retrieval-augmented generation.",
	},
} as const satisfies Record<string, ModelInfo>
