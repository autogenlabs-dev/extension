...
export function showDesignContent(designStyle: string): string {
    ...
    if (designStyle === 'Modern Minimal') {
        ...
        imageUrl = 'https://cdn.dribbble.com/userupload/10922203/file/original-e9ec8adcddec9a8e2fac9c9486c342dc.png?crop=603x452-1812x1359';
        ...
        imageUrl = 'https://cdn.dribbble.com/userupload/10627047/file/original-55e59fa626b6cacef163259302382126.png?crop=0x0-1600x1200';
        ...
        imageUrl = 'https://cdn.dribbble.com/userupload/10920808/file/original-b429a6c9a7939d4449d172ed88a981ca.png?crop=0x0-1600x1200';
...
export function getDesignPrompt(designStyle: string): string {
    ...
    const prompt = "Generate UI components using the " + designStyle + " design style with the following details:\\n" +
        "- Title: " + title + "\\n" +
