...
export const Package = {
	...
	outputChannel: process.env.PKG_OUTPUT_CHANNEL || "Autogenlabs-Code",
} as const
...
const autogenLabsSchema = apiModelIdProviderModelSchema.extend({
	autogenLabsApiKey: z.string().optional(),
	autogenLabsBaseUrl: z.string().optional(),
})
...
export const providerSettingsSchemaDiscriminated = z.discriminatedUnion("apiProvider", [
	...
	groqSchema.merge(z.object({ apiProvider: z.literal("groq") })),	chutesSchema.merge(z.object({ apiProvider: z.literal("chutes") })),
	litellmSchema.merge(z.object({ apiProvider: z.literal("litellm") })),
	autogenLabsSchema.merge(z.object({ apiProvider: z.literal("autogenlabs") })),
	defaultSchema,
])
...
export const providerSettingsSchema = z
	...
	.merge(fakeAiSchema)
	.merge(xaiSchema)	.merge(groqSchema)
	.merge(chutesSchema)
	.merge(litellmSchema)
	.merge(autogenLabsSchema)
...
const providerSettingsRecord: ProviderSettingsRecord = {
	...
	// Chutes AI
	chutesApiKey: undefined,	// LiteLLM
	litellmBaseUrl: undefined,
	litellmApiKey: undefined,
	litellmModelId: undefined,
	// AutogenLabs (A4F.co)
	autogenLabsApiKey: undefined,
	autogenLabsBaseUrl: undefined,
}
