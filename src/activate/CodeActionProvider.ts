...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Autogenlabs Code",
	FIX: "Fix with Autogenlabs Code",
	IMPROVE: "Improve with Autogenlabs Code",
	ADD_TO_CONTEXT: "Add to Autogenlabs Code",
	NEW_TASK: "New Autogenlabs Code Task",
} as const
