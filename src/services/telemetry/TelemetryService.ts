...
/**
 * PostHogClient handles telemetry event tracking for the AutoGen extension
...
class PostHogClient {
	...
	/**
	 * Records when AutoGen calls the task completion_result tool signifying that AutoGen is done with the task
