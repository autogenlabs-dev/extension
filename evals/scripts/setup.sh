...
build_extension() {
  echo "🔨 Building the Autogenlabs Code extension..."
  cd ..
  mkdir -p bin
...
echo -n "🗄️ Syncing Autogenlabs Code evals database... "
...
read -p "💻 Do you want to build a new version of the Autogenlabs Code extension? [currently $current_version] (y/N): " build_extension
