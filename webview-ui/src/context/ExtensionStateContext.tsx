		...
		switch (message.type) {
			...
			case "partialMessage": {
				...
				setState((prevState) => {
					...
					const lastIndex = findLastIndex(prevState.autogenMessages, (msg) => msg.ts === partialMessage.ts)
					if (lastIndex !== -1) {
						const newAutoGenMessages = [...prevState.autogenMessages]
						newAutoGenMessages[lastIndex] = partialMessage
						return { ...prevState, autogenMessages: newAutoGenMessages }
					}
					return prevState
				})
				break
