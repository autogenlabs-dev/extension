...
function getSelectedModel({
	...
	switch (provider) {
		...
		case "autogenlabs": {
			const id = apiConfiguration.apiModelId ?? autogenLabsDefaultModelId
			const info = autogenLabsModels[id as keyof typeof autogenLabsModels]
			return info ? { id, info } : { id: autogenLabsDefaultModelId, info: autogenLabsModels[autogenLabsDefaultModelId] }
		}
		case "groq": {
